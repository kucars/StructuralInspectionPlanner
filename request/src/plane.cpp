...
int main(int argc, char **argv)
{
  ...
  srv.request.spaceSize.push_back(3165);
  ...
  /* starting pose*/
  reqPose.position.x = 50.0;
  reqPose.position.y = 50.0;
  reqPose.position.z = -20.0;
...
//   srv.request.requiredPoses.push_back(reqPose);
  ...
  srv.request.minDist = 200.0;
  srv.request.maxDist = 300.0;
  srv.request.numIterations = 50;

  /* read STL file and publish to rviz */
  std::vector<nav_msgs::Path> * mesh = readSTLfile(ros::package::getPath("request")+"/meshes/plane_simplified.stl");
