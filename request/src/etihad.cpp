...
int main(int argc, char **argv)
{
  ...
  /* starting pose*/
  reqPose.position.x = 4.0;
  reqPose.position.y = -30.0;
  reqPose.position.z = 15.0;
...
//   srv.request.requiredPoses.push_back(reqPose);
  ...
  srv.request.maxDist = 40.0;
  srv.request.numIterations = 5;

  /* read STL file and publish to rviz */
  std::vector<nav_msgs::Path> * mesh = readSTLfile(ros::package::getPath("request")+"/meshes/etihad_nowheels_rotated.stl");
